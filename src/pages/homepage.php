...
<section class="main">
        <div class="container-fluid d-flex flex-column align-items-center">
            ...
            <a href="#title-presta" class="btn-lg btn-primary rounded-pill mt-5 py-3 px-5 btn-green text-decoration-none">Nos prestations<i class="fas fa-angle-down ms-2"></i></a>
        </div>
    </section>
