...
<section class="imgMain d-flex flex-column align-items-center justify-content-center">
    ...
    <div>
        <a class="btn btn-lg btn-outline-light" href="index.php?page=acceler_emploi_atelier">Découvrir nos ateliers</a>
    </div>
</section>
...
<section class="textMain d-flex flex-column align-items-center justify-content-center">
    ...
    <div class="col-md-6 col-10 px-md-0 px-3 py-md-0 py-5 custom-shape-divider-top-1610706305">
        ...
        <p class="text-center">
            ...
            à un accompagnement et un soutien individuel intensif
        </p>
...
<section class="textMain d-flex flex-column align-items-center justify-content-center my-auto">
    ...
    <div class="col-md-6 col-10 px-md-0 px-3 py-md-0 py-5">
        ...
        <p class="text-center pt-3">
            L’ensemble des composantes de la prestation, y compris l’entretien collectif
            d’adhésion, peut se réaliser en présentiel ou distanciel.
        </p>
...
<section class="row ateliers">
    ...
    <div class="col-6 card d-flex">
        <div class="card-body">
            ...
            <p class="card-text">
                L’entretien diagnostic et l’entretien de bilan
                Le bilan intermédiaire est réalisé dans le cadre du sixième atelier incontournable
                Des contacts individuels à la demande et un suivi individuel hebdomadaire pendant le 2ème mois
            </p>
    ...
    <div class="col-6 card d-flex">
        ...
        <div class="card-body">
            ...
            <h5 class="card-title">
                Durant la prestation, le demandeur d'emploi est invité aux événements entreprise
                (au moins un pendant la prestation) pendant la phase de suivi post-prestation.
            </h5>
            <p class="card-text">
                Exemples :
                ...
                Simulation d’entretien avec un recruteur
            </p>
...
<section class="textBottom d-flex flex-column align-items-center justify-content-center">
    ...
    <div class="m-auto">
        <p class="text-center m-auto fs-5 lh-lg ">
            ...
            L’espace co-working offre la possibilité de se réunir librement pour avancer ensemble.
        </p>
    </div>
