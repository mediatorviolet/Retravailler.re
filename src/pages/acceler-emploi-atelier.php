...
<div class="container-fluid p-lg-5 p-md-3 main">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        ...
        $reponse = $bdd->query('SELECT * FROM atelier WHERE id_prestation = 2');
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                        <div class="card-body">
                            ...
                            <select name="date" class="form-select" aria-label="Default select example">
                                ...
                                <?php
                                $response = $bdd->query('SELECT * FROM date_atelier WHERE id_prestation = 2 AND id_atelier = "' . $donnee['id_atelier'] . '" AND etat = 1');
