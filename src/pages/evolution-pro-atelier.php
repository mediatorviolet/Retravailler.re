...
<div class="container-fluid p-lg-5 p-md-3 main">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        ...
        // On sélectionne tous les ateliers liés à la prestation 1 (Conseil en Evolution Professionnelle)
        $req = $bdd->query('SELECT * FROM atelier WHERE id_prestation = 1');
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                        <div class="card-body">
                            ...
                            <select name="date" class="form-select" aria-label="Default select example">
                                ...
                                $req2 = $bdd->query('SELECT * FROM date_atelier WHERE id_prestation = 1 AND id_atelier = "' . $donnee['id_atelier'] . '" AND etat = 1');
                                $data = $req2->fetchAll();
